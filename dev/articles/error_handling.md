...
```
     ...
     1:  4.6446354 12.523384 appalling_... Random Err... 3c9e3515-4...
     2: -1.5554369  9.506781 zombified_... Random Err... f7fe6e00-e...
     3: -0.9094726  1.586373 current_wh... Random Err... 405e0243-6...
     4:  2.5018837  7.961961 horsy_harr... Random Err... f6931a50-6...
     5:  5.2527948  8.759693 current_wh... Random Err... 0e700dce-b...
    ---
    83: -0.7885847  7.207431 zombified_... Random Err... 7447f77a-6...
    84: -3.6078121 11.911872 appalling_... Random Err... 530a561f-4...
    85: -2.5127582 13.234387 zombified_... Random Err... 3404b99a-1...
    86: -2.0267331  3.985356 horsy_harr... Random Err... fe333711-5...
    87: -0.3052349  4.585138 appalling_... Random Err... 48207a1e-5...
...
```
    ...
    [1] "copper_nurseshark" "almondy_roller"   
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1: 5.652283 5.020908 copper_nur... Worker has... 42f6f8b9-3...
    2: 1.722546 7.840571 almondy_ro... Worker has... 7be21f84-8...
...
```
    ...
    [1] "Debug message logging on worker meritocrat_harpyeagle started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker meritocrat_harpyeagle started\""
