...
```
     ...
     1:  3.4463307 10.008599 unirritate... Random Err... 9c24ff38-1...
     2:  7.9813342  5.779626 cursorial_... Random Err... d99ef3ec-f...
     3:  5.3520595  2.126168 cubiform_b... Random Err... b0233d81-5...
     4:  3.3765790  5.842917 wistful_bl... Random Err... 74b6b8d5-b...
     5: -1.1612769 11.654995 unirritate... Random Err... faebe0a4-2...
    ---
    82:  5.6666272  4.976583 wistful_bl... Random Err... 1fb52352-e...
    83:  0.2729622  4.424154 unirritate... Random Err... 913c18b0-6...
    84:  9.9657564 12.084996 cursorial_... Random Err... 20267145-d...
    85: -3.4975020  2.140679 unirritate... Random Err... 8e0f09eb-f...
    86:  7.0880859  2.998963 cursorial_... Random Err... daf956d8-d...
...
```
    ...
    [1] "supernaturalistic_bobcat" "kooky_bullfrog"          
...
```
              ...
              x1       x2     worker_id       message          keys
           <num>    <num>        <char>        <char>        <char>
    1: -0.469864 7.328770 supernatur... Worker has... 64c4a4e0-a...
    2:  8.009508 7.989834 kooky_bull... Worker has... abc42892-6...
...
```
    ...
    [1] "Debug message logging on worker crystalloid_africanhornbill started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker crystalloid_africanhornbill started\""
