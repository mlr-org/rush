...
```
      ...
      1:  8.961406  4.650334 wellfreckl... Random Err... b78bb8d2-b...
      2:  1.464972 11.162632 transparen... Random Err... 57cfafeb-0...
      3:  9.434571  6.027078 expeditiou... Random Err... 6764f72d-7...
      4:  7.627070  9.417491 offbeat_wa... Random Err... 22488c78-c...
      5:  2.354884 14.592579 wellfreckl... Random Err... b95b1c8e-f...
     ---
    108:  4.677333 14.881735 offbeat_wa... Random Err... f358a4e1-6...
    109: -4.379658  8.323734 wellfreckl... Random Err... f3e3b752-9...
    110:  8.190029 12.002848 offbeat_wa... Random Err... b7a1f90d-c...
    111:  6.173976  8.861038 wellfreckl... Random Err... d5f07fb5-e...
    112:  4.446100  5.750621 offbeat_wa... Random Err... a9b3989e-0...
...
```
    ...
    [1] "annoying_cicada" "icecold_husky"  
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1: 8.176144 7.643782 annoying_c... Worker has... 607a8ff7-1...
    2: 1.373367 1.538113 icecold_hu... Worker has... b6148c98-0...
...
```
    ...
    [1] "Debug message logging on worker desertlike_siberiantiger started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker desertlike_siberiantiger started\""
