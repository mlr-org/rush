...
```
      ...
      1:  5.2512535 6.29967778 peewee_urv... <list[1]> afc1b4c3-9...
      2: -0.5444697 9.58259431 chronologi... <list[1]> 48229919-2...
      3:  8.4069029 0.18960602 soubrettis... <list[1]> 1c782414-9...
      4: -2.0535018 0.09217502 peewee_urv... <list[1]> ae4a5736-0...
      5:  6.3736042 4.46044938 chronologi... <list[1]> 2a0a9a97-6...
     ---
     99:  8.4137493 7.67130615 chronologi... <list[1]> 2abbd465-1...
    100:  3.3322026 7.74054313 peewee_urv... <list[1]> 1723945f-d...
    101: -1.0881557 9.60753056 soubrettis... <list[1]> 0243fa7f-d...
    102:  3.5485252 1.52512346 mesodermic... <list[1]> f27df7c7-2...
    103: -2.0777253 7.08141230 chronologi... <list[1]> 2390c302-0...
...
```
    ...
    [1] "disyllabic_caimanlizard" "noncarnivorous_limpkin" 
...
```
              ...
              x1        x2     worker_id condition          keys
           <num>     <num>        <char>    <list>        <char>
    1: -3.136003 14.512921 disyllabic... <list[1]> c332be26-a...
    2:  3.254384  7.285776 noncarnivo... <list[1]> 186500f1-e...
...
```
    ...
    [1] "Debug message logging on worker blitheful_indusriverdolphin started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker blitheful_indusriverdolphin started\""
