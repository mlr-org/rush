...
```
      ...
      1:  9.178095 12.8269712 ironical_i... Random Err... e3faef4f-3...
      2:  5.637957 14.7585105 flirtatiou... Random Err... 4046d595-a...
      3:  3.120724  3.3485726 exothermic... Random Err... 2912279b-a...
      4:  5.892160  8.0023006 downtrodde... Random Err... 77197186-8...
      5:  8.961258 13.6458368 downtrodde... Random Err... 034cc202-0...
     ---
    115: -4.088862  8.7965224 downtrodde... Random Err... d45d5d3e-1...
    116:  6.116397 14.3717636 flirtatiou... Random Err... 77fc3cc5-0...
    117:  8.480561  0.1406091 ironical_i... Random Err... c76ccabf-3...
    118:  7.210946 13.1039222 flirtatiou... Random Err... a2813fec-1...
    119:  2.859906 10.0425836 downtrodde... Random Err... 7e254a93-d...
...
```
    ...
    [1] "crippling_mice"    "leading_norwayrat"
...
```
             ...
             x1        x2     worker_id       message          keys
          <num>     <num>        <char>        <char>        <char>
    1: 9.678510  1.609246 crippling_... Worker has... deb68935-1...
    2: 2.393577 12.780808 leading_no... Worker has... dc8f5a56-c...
...
```
    ...
    [1] "Debug message logging on worker apish_swift started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker apish_swift started\""
