...
```
     ...
     1:  6.0709640 10.6375764 vivid_eski... Random Err... 3bbdd8b8-f...
     2:  5.9913631  1.5561381 straightla... Random Err... f036a208-a...
     3: -0.5969619  0.6616371 undrinkabl... Random Err... 6b21e13e-2...
     4:  6.7214709 12.6249344 vivid_eski... Random Err... fc24b182-6...
     5:  7.9068045  1.1448581 volumed_fi... Random Err... 61e84560-2...
    ---
    90:  1.0240304  6.7682748 vivid_eski... Random Err... 58fb5fb6-8...
    91:  7.5469071  5.4073676 volumed_fi... Random Err... f08bb0c9-d...
    92:  4.6143989  6.6307685 straightla... Random Err... 5d23f7ea-a...
    93:  8.3863499 14.2041007 vivid_eski... Random Err... 89a4fff8-8...
    94:  5.2821167  4.4352373 undrinkabl... Random Err... c4f63332-7...
...
```
    ...
    [1] "transplanetary_bobcat" "homebred_schnauzer"   
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1: 5.001415 9.656143 transplane... Worker has... 445e236a-5...
    2: 6.821272 7.290691 homebred_s... Worker has... 4dc85183-b...
...
```
    ...
    [1] "Debug message logging on worker bonelike_electriceel started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker bonelike_electriceel started\""
