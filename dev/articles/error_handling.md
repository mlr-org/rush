...
```
     ...
     1: -0.03215915 11.161388 arid_honey... Random Err... 94dcd7fd-c...
     2: -4.68553771  9.118825 scarred_sp... Random Err... c3dd47a5-5...
     3:  7.16793900  3.990790 igniteable... Random Err... 7324de4e-1...
     4:  8.36448994  8.188968 igniteable... Random Err... 77f0127a-8...
     5:  0.83367293 14.726387 complexion... Random Err... 58959ae6-f...
    ---
    85: -4.12140196 12.854352 igniteable... Random Err... e91e00c7-b...
    86:  0.53082857 13.567023 complexion... Random Err... 89d997db-e...
    87: -0.41559355  4.583725 scarred_sp... Random Err... 4b77722b-f...
    88:  8.32513379  4.801485 igniteable... Random Err... 0ff3e0d3-0...
    89:  4.18761334  3.431746 scarred_sp... Random Err... ae4d2282-e...
...
```
    ...
    [1] "deformable_xenotarsosaurus" "legatine_noddy"            
...
```
              ...
              x1        x2     worker_id       message          keys
           <num>     <num>        <char>        <char>        <char>
    1: 0.2463917  1.354661 deformable... Worker has... 088eed85-7...
    2: 3.8233305 13.653134 legatine_n... Worker has... 06e3c042-5...
...
```
    ...
    [1] "Debug message logging on worker fiery_ghostshrimp started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker fiery_ghostshrimp started\""
