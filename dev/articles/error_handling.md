...
```
     ...
     1: -3.101263  3.3203623 cubic_baij... Random Err... 691f81b6-2...
     2:  1.507074 12.1054701 intestinal... Random Err... 56b88d56-6...
     3: -2.259595 13.6208868 cyan_littl... Random Err... 9f640dd1-6...
     4: -4.394738  3.4160531 cubic_baij... Random Err... e2bf90d2-1...
     5:  1.646456  0.7597636 culpable_a... Random Err... 7b458f76-c...
    ---
    83:  1.577799  8.6782718 cyan_littl... Random Err... 7ee148dd-6...
    84:  3.265411  3.1580393 culpable_a... Random Err... 99c13565-9...
    85: -1.907519  1.6118051 cubic_baij... Random Err... f917ba67-c...
    86:  4.506163  1.5594033 cyan_littl... Random Err... 128d6440-c...
    87: -4.046719 11.2340515 cubic_baij... Random Err... 9b908dac-6...
...
```
    ...
    [1] "thickwitted_davidstiger" "large_addax"            
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1: 1.000924 1.546912 thickwitte... Worker has... 27919a16-d...
    2: 3.071121 9.979936 large_adda... Worker has... 280d0961-a...
...
```
    ...
    [1] "Debug message logging on worker spotty_husky started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker spotty_husky started\""
