...
```
      ...
      1: -0.3722074  5.187290 epistemolo... Random Err... c2b60237-4...
      2:  4.3001332  6.293792 epistemolo... Random Err... 80bc2d8d-f...
      3:  3.3783423 11.068144 epistemolo... Random Err... afb28ee7-5...
      4:  2.1085565  8.177258 epistemolo... Random Err... f589892d-d...
      5: -3.6775974 11.142389      emo_colt Random Err... e1be697d-a...
     ---
     97:  6.9678887 11.439644 wellplease... Random Err... 03520fc4-c...
     98:  4.0553489  5.243293      emo_colt Random Err... 253258af-b...
     99:  4.5920015 10.832714 sheer_pitt... Random Err... 3ce96295-7...
    100: -4.9802351 10.549740 sheer_pitt... Random Err... e7315954-4...
    101:  9.6763728  1.171358 wellplease... Random Err... 83e56a34-c...
...
```
    ...
    [1] "exhaustive_mayfly" "fanciful_stonefly"
...
```
              ...
              x1        x2     worker_id       message          keys
           <num>     <num>        <char>        <char>        <char>
    1:  7.190990  2.971243 exhaustive... Worker has... 70d8d6b3-4...
    2: -2.673882 11.902514 fanciful_s... Worker has... a4f64d52-9...
...
```
    ...
    [1] "Debug message logging on worker injurious_okapi started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker injurious_okapi started\""
