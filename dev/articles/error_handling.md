...
```
     ...
     1:  1.932260 11.343404 sublinear_... Random Err... 505aed22-9...
     2:  6.193998  5.068487    veiny_boar Random Err... 2d024f66-0...
     3: -4.154700  6.619907 unsalty_lo... Random Err... 6f216177-d...
     4:  8.825641  5.794277 philanthro... Random Err... d09e1d81-a...
     5: -1.239116 13.488217 sublinear_... Random Err... f0409eb0-8...
    ---
    81:  3.747037  2.302930 philanthro... Random Err... 3ce1e2db-5...
    82:  1.946475 12.159051 sublinear_... Random Err... 8cf0ad82-f...
    83:  5.922747  1.240139 sublinear_... Random Err... fc67b80f-4...
    84:  7.279498  9.821264    veiny_boar Random Err... 385c79f5-0...
    85:  2.864459 14.838581    veiny_boar Random Err... f498dbce-1...
...
```
    ...
    [1] "tricksome_wrasse"     "spiritless_seamonkey"
...
```
              ...
              x1        x2     worker_id       message          keys
           <num>     <num>        <char>        <char>        <char>
    1: -1.513414 14.971327 tricksome_... Worker has... d5419d3a-c...
    2:  3.884685  9.682586 spiritless... Worker has... 929a5ba8-0...
...
```
    ...
    [1] "Debug message logging on worker semiexperimental_amethystsunbird started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker semiexperimental_amethystsunbird started\""
