...
```
     ...
     1: -2.3269304 14.79551496 unamusable... Random Err... 85d2b784-a...
     2: -1.6649227  3.02067108 abashed_ma... Random Err... e302fbc3-4...
     3: -4.8103727 11.49180632 dryadic_fl... Random Err... c4d0440a-4...
     4: -4.5109701  0.08210431 rainbow_fi... Random Err... bd52e96d-d...
     5: -0.1174801 13.61508904 abashed_ma... Random Err... 9cf2ce55-8...
    ---
    90: -0.5289272  5.82324167 unamusable... Random Err... 8bca3a92-a...
    91:  9.2844390  9.93324520 rainbow_fi... Random Err... cccc0207-d...
    92:  3.2186067  8.81549211 unamusable... Random Err... c7d002f2-6...
    93: -3.8125241 11.32916024 abashed_ma... Random Err... f993b3d0-a...
    94: -2.8765122 12.77021708 abashed_ma... Random Err... 3d348959-d...
...
```
    ...
    [1] "precapitalistic_muskox"      "injudicious_northernfurseal"
...
```
              ...
              x1        x2     worker_id       message          keys
           <num>     <num>        <char>        <char>        <char>
    1: -2.382477 12.879482 precapital... Worker has... 78fc450c-5...
    2: -3.507620  3.752392 injudiciou... Worker has... 3964556b-a...
...
```
    ...
    [1] "Debug message logging on worker stigmatophilic_gavial started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker stigmatophilic_gavial started\""
