...
```
      ...
      1:  5.300881  7.1672081 cowlike_wu... <list[1]> ba25b697-b...
      2:  8.905110 10.0430978 elfin_gard... <list[1]> 1ceedeea-e...
      3:  3.441332  2.6095108 weatherpro... <list[1]> d7a8516e-4...
      4: -4.965451  9.6474641 cowlike_wu... <list[1]> 1a893b03-8...
      5:  8.094094  0.3750661 weatherpro... <list[1]> 17061a38-d...
     ---
    103: -2.171342 13.7844470 elfin_gard... <list[1]> bf2115b3-6...
    104:  2.836150  7.0577562 weatherpro... <list[1]> ad97821a-0...
    105:  2.674649 12.0075321 cowlike_wu... <list[1]> 2cd31dcd-a...
    106:  7.517715  5.1257624 emancipati... <list[1]> fccf3e94-e...
    107:  1.037588  2.0732161 cowlike_wu... <list[1]> c02a1aa6-f...
...
```
    ...
    [1] "dismissive_bronco_d0ab2f3e"      "ritualistic_angwantibo_f17fd791"
...
```
            ...
            x1       x2     worker_id condition          keys
         <num>    <num>        <char>    <list>        <char>
    1: 3.02746 11.16588 dismissive... <list[1]> b6a65adf-e...
    2: 2.18047 12.83719 ritualisti... <list[1]> 83925f2e-7...
...
```
    ...
    [1] "Debug message logging on worker suppletive_elephantseal_454cd4af started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker suppletive_elephantseal_454cd4af started\""
