...
```
      ...
      1: -4.1474605  7.6301481 anticapita... Random Err... 6d7c1833-c...
      2:  3.6518201  1.4425131 worldwide_... Random Err... aab36d15-9...
      3:  5.1157153  5.2839173 anticapita... Random Err... 1b2bc6a9-4...
      4:  4.0024689 13.0945995 anticapita... Random Err... 3b9056c9-0...
      5:  8.6302078  0.2891387 flat_macaq... Random Err... 03f404ac-4...
     ---
    141:  1.6823178 14.2498858 worldwide_... Random Err... 1c0bcc2a-0...
    142:  5.8072541  4.7080221 worldwide_... Random Err... 4373eab5-9...
    143:  9.8186703  0.5195179 varied_ils... Random Err... dc10a6e7-6...
    144:  0.3551458  5.5187175 flat_macaq... Random Err... de2fe713-a...
    145: -2.6174671  6.5036300 anticapita... Random Err... a2e1b439-a...
...
```
    ...
    [1] "soulful_chuckwalla"     "solid_ulyssesbutterfly"
...
```
             ...
             x1        x2     worker_id       message          keys
          <num>     <num>        <char>        <char>        <char>
    1: 8.537565 14.980389 soulful_ch... Worker has... 13a45969-7...
    2: 3.434429  5.964963 solid_ulys... Worker has... f47e962d-4...
...
```
    ...
    [1] "Debug message logging on worker nearby_dogwoodtwigborer started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker nearby_dogwoodtwigborer started\""
