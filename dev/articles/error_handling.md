...
```
     ...
     1:  4.2543284  9.7449338 controlles... Random Err... c89ba1d1-5...
     2:  5.4677062 14.3729257 controlles... Random Err... 88f1ca2c-5...
     3: -0.1765078  0.9121370 controlles... Random Err... 4dd12a88-d...
     4:  8.3862870  1.2628609 controlles... Random Err... 77fc50d3-f...
     5:  4.7230602  2.6405356 controlles... Random Err... 3dec47a3-b...
    ---
    84: -4.5686036 10.6083215 disregardf... Random Err... d0d66bfe-c...
    85:  6.8956432  2.7262038 controlles... Random Err... 9a164af6-0...
    86:  9.6353431  5.5377237 frogged_ph... Random Err... 83ac604b-6...
    87:  3.4881455  4.6713744 psychedeli... Random Err... e569c140-1...
    88:  5.2501287  0.3383983 disregardf... Random Err... 01f38403-9...
...
```
    ...
    [1] "shortcircuited_hairstreak" "demotic_bronco"           
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1: 9.554404 7.013101 shortcircu... Worker has... d9b0b701-6...
    2: 7.763871 2.591112 demotic_br... Worker has... a188c093-9...
...
```
    ...
    [1] "Debug message logging on worker hexadic_komododragon started"

``` r
readLines(file.path(output_log, sprintf("output_%s.log", worker_ids[1])))
```

    [1] "[1] \"Debug output logging on worker hexadic_komododragon started\""
