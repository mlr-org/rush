...
```
      ...
      1:  5.67887587 11.464152 single_nor... <list[1]> 79797fa9-7...
      2:  8.29022948  5.606089 censorable... <list[1]> 2ed9e08b-6...
      3: -0.07652132  3.604851 censorable... <list[1]> de3d0790-e...
      4:  9.43772468  4.179788 contentiou... <list[1]> 4eba30d3-e...
      5: -1.92930803 14.373816 overconfid... <list[1]> afd1c9ac-4...
     ---
    105: -2.28854795 10.071458 contentiou... <list[1]> 848a54fa-4...
    106:  5.68028851  2.038289 overconfid... <list[1]> 9e438314-5...
    107:  5.17343248 10.344296 censorable... <list[1]> bc42d6cb-e...
    108: -1.21275531 11.290098 single_nor... <list[1]> 3c8e068a-f...
    109:  6.78019285  2.105402 overconfid... <list[1]> e7f3a2ab-d...
...
```
    ...
    [1] "removable_quokka_f5132f84"     "beneficial_kittiwake_401e7150"
...
```
              ...
              x1       x2     worker_id condition          keys
           <num>    <num>        <char>    <list>        <char>
    1:  2.117027 8.671079 removable_... <list[1]> 16844a30-4...
    2: -3.270457 8.114952 beneficial... <list[1]> 49abacca-5...
...
```
    ...
    [1] "pseudocrystalline_australianshelduck_7f196fa2"
...
```
    ...
    [1] "Debug message logging on worker lonely_tarsier_aaae3653 started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker lonely_tarsier_aaae3653 started\""
