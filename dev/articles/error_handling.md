...
```
      ...
      1: -2.1896203  4.775691 palaeobota... Random Err... 47b6ea9c-1...
      2:  2.4070815  3.632787 palaeobota... Random Err... 91fc396a-3...
      3: -2.6563996  1.928218 palaeobota... Random Err... 30479e70-e...
      4: -3.2022542  5.584765 kinaesthet... Random Err... 123dde2e-4...
      5:  4.5165153 12.160915 ulcerous_s... Random Err... f2a42523-a...
     ---
    112:  8.2787861 10.050837 ulcerous_s... Random Err... 85e04efe-d...
    113:  8.8056364 13.387789 kinaesthet... Random Err... d4826fe6-3...
    114:  7.9960423  3.344782 palaeobota... Random Err... 29a54470-6...
    115:  0.2407748 13.598770 kinaesthet... Random Err... f701aedc-0...
    116: -4.6318124  3.177205 ulcerous_s... Random Err... 775254a3-4...
...
```
    ...
    [1] "underage_urva"      "inedible_pekingese"
...
```
             ...
             x1        x2     worker_id       message          keys
          <num>     <num>        <char>        <char>        <char>
    1: 1.262607 3.0704419 underage_u... Worker has... af88f334-a...
    2: 1.562306 0.7121376 inedible_p... Worker has... 0e8e8a7c-2...
...
```
    ...
    [1] "Debug message logging on worker topazine_darklingbeetle started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker topazine_darklingbeetle started\""
