...
```
      ...
      1:  9.1708169  8.1221262 unawake_ha... <list[1]> 1af86b6d-7...
      2: -0.1345015 14.5780490 encyclopae... <list[1]> 7a6bd366-0...
      3:  4.1358632  0.7181980 ochre_amph... <list[1]> 42e3b578-0...
      4:  5.3984995  9.7826718 vigorous_w... <list[1]> 6005442b-0...
      5: -3.6711962  1.7291076 unawake_ha... <list[1]> a69fcc0f-b...
     ---
    136:  0.5409782 11.9359336 ochre_amph... <list[1]> ffabf27a-5...
    137:  3.3668263  0.6354421 unawake_ha... <list[1]> 99cda923-f...
    138:  7.0183581  7.1340802 unawake_ha... <list[1]> 5bc202ce-4...
    139: -2.5380220  6.4729154 unawake_ha... <list[1]> 0ea40469-c...
    140: -1.2566665  2.2688512 vigorous_w... <list[1]> 4fdc1664-a...
...
```
    ...
    [1] "esthetic_cutworm"      "uncalorific_springbok"
...
```
             ...
             x1       x2     worker_id condition          keys
          <num>    <num>        <char>    <list>        <char>
    1: 5.261369 1.717733 esthetic_c... <list[1]> 5686e34e-5...
    2: 3.251556 1.493558 uncalorifi... <list[1]> 28c8b713-6...
...
```
    ...
    [1] "Debug message logging on worker vermivorous_sora started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker vermivorous_sora started\""
