...
```
     ...
     1:  2.6721078  5.302418 paleogrogr... Random Err... 7a8dd739-c...
     2:  4.8642476  2.268061 paleogrogr... Random Err... 2450db17-f...
     3: -1.1324472  7.784309 paleogrogr... Random Err... eef6941b-e...
     4:  9.5974461 11.152134 paleogrogr... Random Err... bd60d75d-9...
     5: -0.1208347 12.980367 coltish_sk... Random Err... ce1c7535-8...
    ---
    94:  2.7342486  7.526447 coltish_sk... Random Err... 20f789b4-b...
    95: -2.8139312  9.480622 paleogrogr... Random Err... 562288fa-a...
    96:  7.3505594  1.592498 nihilistic... Random Err... 30033511-1...
    97: -2.3515330  4.341275 coltish_sk... Random Err... 20d7c609-4...
    98:  3.9643121  4.592398 paleogrogr... Random Err... 2b4fe065-9...
...
```
    ...
    [1] "clothed_gibbon"     "surefooted_opossum"
...
```
             ...
             x1        x2     worker_id       message          keys
          <num>     <num>        <char>        <char>        <char>
    1: 5.853421 10.152029 clothed_gi... Worker has... 2002e294-7...
    2: 6.699319  7.076987 surefooted... Worker has... 68002017-f...
...
```
    ...
    [1] "Debug message logging on worker grieving_dalmatian started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker grieving_dalmatian started\""
