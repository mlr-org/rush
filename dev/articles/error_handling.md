...
```
      ...
      1: -1.193750  9.021561 detractive... Random Err... c084dbce-2...
      2:  9.026653  3.951999 excisable_... Random Err... d9dfb00b-a...
      3:  1.832949 12.220344 quicktempe... Random Err... 043c2327-1...
      4:  2.813217  4.852094 discreet_a... Random Err... 1cd3f9ee-e...
      5:  4.052400 14.125024 quicktempe... Random Err... 332dcf90-6...
     ---
    103:  2.356000  8.063135 quicktempe... Random Err... 15d6cc1d-9...
    104: -3.567711  6.731771 detractive... Random Err... a3cfb5de-5...
    105:  4.306986 13.969026 discreet_a... Random Err... a3d93733-7...
    106:  3.752595 11.621577 excisable_... Random Err... d326723d-3...
    107: -4.541565  2.359035 detractive... Random Err... a5919a20-7...
...
```
    ...
    [1] "druidic_hart"            "electromagnetic_ragfish"
...
```
             ...
             x1       x2     worker_id       message          keys
          <num>    <num>        <char>        <char>        <char>
    1:  3.71847 8.209715 druidic_ha... Worker has... e7553451-9...
    2: -4.81248 6.814629 electromag... Worker has... 21b1896d-a...
...
```
    ...
    [1] "overconstant_intermediateegret"
...
```
    ...
    [1] "Debug message logging on worker bedridden_urutu started"
...
```
    ...
    [1] "[1] \"Debug output logging on worker bedridden_urutu started\""
