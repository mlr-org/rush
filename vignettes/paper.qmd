...
Asynchronous Decentralized Bayesian Optimization (ADBO) [@egele_2023] distributes the surrogate updates and the acquisition function optimization across the workers.
...
The benchmarks are focused on the effective CPU utilization of the algorithms following the recommendations of @egele_2023.
...
| Task               | Algorithm | Mean Runtime Learners [s] | Evaluations | Utilization |
|:-------------------|:----------|--------------------------:|------------:|------------:|
| german-credit      | CL        |                         1 |         396 |      0.0033 |
|                    | ACBO      |                         1 |         461 |      0.0031 |
|                    | ADBO      |                         1 |      15,451 |      0.9500 |
| kddcup09-appetency | CL        |                        27 |         132 |      0.0110 |
|                    | ACBO      |                        23 |         473 |      0.0450 |
|                    | ADBO      |                        30 |       6,702 |      0.9400 |
| adult              | CL        |                        11 |         308 |      0.0160 |
|                    | ACBO      |                        12 |         463 |      0.0230 |
|                    | ADBO      |                        14 |      10,169 |      0.9600 |
| airlines           | CL        |                       313 |          88 |      0.0970 |
|                    | ACBO      |                       183 |         435 |      0.3100 |
|                    | ADBO      |                       261 |         993 |      1.0000 |
:::
...
On tasks with very short learner runtimes, centralized methods leave most compute resources idle.
This effect is particularly visible on the german-credit task.
Here, CL and ACBO complete only a few hundred evaluationhttps://github.com/slds-lmu/paper_2026_rushs.
In contrast, ADBO completes more than an order of magnitude additional evaluations.
The utilization gap exceeds two orders of magnitude in this regime.
...
The wall-clock runtime of CLBO frequently exceeds the nominal 10-minute budget.
This effect is documented in Table @tbl-benchmarks-extra.
CLBO checks the termination criterion only after an entire batch finishes.
...
Asynchronous scheduling therefore improves both utilization and budget compliance.
