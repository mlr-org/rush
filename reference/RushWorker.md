...
worker inherits from [Rush](https://rush.mlr-org.com/reference/Rush.md).
...
- [`rush::Rush$fetch_priority_tasks()`](https://rush.mlr-org.com/reference/Rush.html#method-fetch_priority_tasks)
...
- [`rush::Rush$push_priority_tasks()`](https://rush.mlr-org.com/reference/Rush.html#method-push_priority_tasks)
...
- [`rush::Rush$restart_workers()`](https://rush.mlr-org.com/reference/Rush.html#method-restart_workers)
...
- [`rush::Rush$wait_for_finished_tasks()`](https://rush.mlr-org.com/reference/Rush.html#method-wait_for_finished_tasks)
- [`rush::Rush$wait_for_new_tasks()`](https://rush.mlr-org.com/reference/Rush.html#method-wait_for_new_tasks)
...
- `config`:
  ...
  used. If
  [`rush_plan()`](https://rush.mlr-org.com/reference/rush_plan.md) has
  not been called, the `REDIS_URL` environment variable is parsed. If
...
- `remote`:
  ...
  [Rush](https://rush.mlr-org.com/reference/Rush.md) for details.
