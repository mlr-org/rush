...
article](https://rush.mlr-org.com/articles/rush.md) to demonstrate how
...
```
    ...
    1: augmented_... 11181  FALSE runnervmf2...     FALSE running
    2: skeptical_... 11192  FALSE runnervmf2...     FALSE running
    3: supporting... 11207  FALSE runnervmf2...     FALSE running
    4: bouncy_ala... 11197  FALSE runnervmf2...     FALSE running
...
```
    ...
    3: supporting... 11207  FALSE runnervmf2...     FALSE running
    4: bouncy_ala... 11197  FALSE runnervmf2...     FALSE running
    5: lexicologi... 11336  FALSE runnervmf2...     FALSE running
    6: rust_chuck... 11338  FALSE runnervmf2...     FALSE running
...
```
           ...
           worker_id   pid remote      hostname heartbeat   state
              <char> <int> <lgcl>        <char>    <lgcl>  <char>
    1: skeptical_... 11192  FALSE runnervmf2...     FALSE running
    2: supporting... 11207  FALSE runnervmf2...     FALSE running
    3: bouncy_ala... 11197  FALSE runnervmf2...     FALSE running
    4: lexicologi... 11336  FALSE runnervmf2...     FALSE running
    5: rust_chuck... 11338  FALSE runnervmf2...     FALSE running
    6: augmented_... 11181  FALSE runnervmf2...     FALSE  killed
...
```
           ...
           worker_id   pid remote      hostname heartbeat   state
              <char> <int> <lgcl>        <char>    <lgcl>  <char>
    1: gastroscop... 11413  FALSE runnervmf2...     FALSE running
    2: incognisan... 11415  FALSE runnervmf2...     FALSE running
...
```
           ...
           worker_id   pid remote      hostname heartbeat  state
              <char> <int> <lgcl>        <char>    <lgcl> <char>
    1: unrelative... 11489  FALSE runnervmf2...     FALSE   lost
    2: hazy_yello... 11491  FALSE runnervmf2...     FALSE   lost
...
```
           ...
           worker_id   pid remote      hostname heartbeat   state
              <char> <int> <lgcl>        <char>    <lgcl>  <char>
    1: unrelative... 11561  FALSE runnervmf2...     FALSE running
    2: hazy_yello... 11491  FALSE runnervmf2...     FALSE    lost
...
```
           ...
           worker_id   pid remote      hostname heartbeat   state
              <char> <int> <lgcl>        <char>    <lgcl>  <char>
    1: biotechnol... 11713   TRUE runnervmf2...     FALSE running
    2: annihilate... 11711   TRUE runnervmf2...     FALSE running
